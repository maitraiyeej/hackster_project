                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    className="w-full text-left p-5 border border-black hover:bg-black hover:text-white transition-all group"
                                >
                                    <p className="text-[10px] font-bold uppercase tracking-widest">Manage All Events</p>
                                    <p className="text-xs text-gray-500 group-hover:text-gray-300">View, Edit, or Delete your hackathons</p>
                                </button>
                                <button onClick={() => navigate('/explore')} className="w-full text-left p-4 border border-black hover:bg-black hover:text-white transition-all group">
